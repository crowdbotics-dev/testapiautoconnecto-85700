...
## Project Structure
    ...
    ├── testapiautoconnecto_85700  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_85700`
...
2. Clone this repo and `cd testapiautoconnecto_85700`
